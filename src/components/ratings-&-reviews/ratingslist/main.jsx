...
const RatingsList = props => {
  ...
  return (
    <div className="column is-two-thirds" >
      ...
      <br/>
      <div className="tile is-12 is-vertical is-parent" style={{"height": "480px", "overflow":"auto"}}>
      {fakeProp.map(review => (
        <RatingsListEntry key={review.review_id} review={review} />
      ))}
      </div>
      <br/>
